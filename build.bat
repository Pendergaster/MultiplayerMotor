...
IF /I "%1"=="build_debug" (
		...
		REM 
		cl %CLAGS_DEBUG% -Z7 -nologo /EHsc /fp:fast ..\..\src\client\main.cpp %includes% -D_ITERATOR_DEBUG_LEVEL#2 /MDd /link %libs% -LIBPATH:../../libs/debuglibs 
		REM /DEBUG 
		popd
		)
...
IF /I "%1"=="build_release" (
		...
		pushd %BUILD_DIR%\client\
		REM 
		cl %CLAGS_RELEASE% -nologo /EHsc /DEBUG /fp:fast ..\..\src\client\main.cpp  -D_ITERATOR_DEBUG_LEVEL#0 %includes% /MD /link %libs% -LIBPATH:../../libs/releaselibs 
		popd
		)
...
IF /I "%1"=="build_server" (
		...
		REM 
		cl %CLAGS_DEBUG% -Z7 -nologo /EHsc /fp:fast ..\..\src\server\main.cpp %includes% -D_ITERATOR_DEBUG_LEVEL#2 /MDd /link %libs% -LIBPATH:../../libs/debuglibs 
		popd
		)
